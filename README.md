...
Passionate about **Full Stack Development**, **Artificial Intelligence**, **Network Security**, and building innovative digital solutions.
...
![Cybersecurity](https://img.shields.io/badge/Cybersecurity-1679A7?style=for-the-badge&logo=hackthebox&logoColor=white)
...
- **OCI AI Foundations Associate** – Oracle, 2026
- **Java SE 17 Developer** – Oracle, 2026
- **Deep Learning Specialization** – DeepLearning.AI / Coursera, 2026
- **Mathematics for Machine Learning** – Imperial College London / Coursera, 2026
- **IBM Generative AI Engineering** – IBM / Coursera, 2026
- **IBM RAG and Agentic AI** – IBM / Coursera, 2026
- **IBM AI Engineering** – IBM / Coursera, 2026
- **IBM DevOps and Software Engineering** – IBM / Coursera, 2026
- **AWS Cloud Solutions Architect** – AWS / Coursera, 2026
- **Google Cloud Digital Leader** – Google / Coursera, 2026
- **Google Cybersecurity** – Google / Coursera, 2026
- **Google Project Management** – Google / Coursera, 2026
- **Meta Full Stack Developer** – Meta / Coursera, 2026
- **Data Structures & Algorithms** – Coursera, 2025
- **Big Data Specialization** – UC San Diego / Coursera, 2025
- **Snowflake Data Engineering** – Snowflake Northstar / Coursera, 2025
- **Python for Data Science, AI & Dev** – IBM / Coursera, 2025
---

## 📁 Featured Projects

### 🛣️ RoadVisionAI — AI Road Damage Detection *(Internship 4A — DGR, in progress)*
